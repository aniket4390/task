...
final userController = Get.find<UserController>();  //controller 
      ...
      body: Container(
        ...
        child: Center(
          child: Container(
            ...
            height: 400.0,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),border: Border.all(color: Colors.grey,width: 1.0),color: Color(0xFFFAFAFA)),
            child: Column(
              children: [
